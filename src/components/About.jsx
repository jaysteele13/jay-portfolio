...
const ServiceCard = ({ index, title, icon }) => (
  <Tilt className="xs:w-[250px] w-full">
    <motion.div
      ...
      className="w-full green-pink-gradient p-[1px] rounded-[20px] shadow-card" style={{ background: `linear-gradient(to bottom, ${styles.leadColour}, ${styles.offColour})` }}
    >
      <div
        options={{
          max: 45,
  ...
  return (
    <>
      ...
      >
        ...
        app development, and robotics. I am currently employed at Liberty IT where I focus on driving innovation, fostering collaboration, 
